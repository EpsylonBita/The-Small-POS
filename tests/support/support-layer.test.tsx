...
test('buildGoogleMapsDirectionsUrl opens the delivery destination when store origin is unavailable', () => {
  ...
  assert.equal(
    url,
    'https://www.google.com/maps/search/?api=1&query=12+Main+Street',
  );
});
