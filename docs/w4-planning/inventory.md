...
| Prior desktop framework path | **Retired 2026-04-23** per project memory. | Confirmed by user as the basis for the W4d "no dual-shape, single coordinated cutover" decision. |
